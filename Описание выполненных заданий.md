#greetings.py (Созданы базовые переменные для нашей заметки: username, title, content, status, created_date, issue_date. Вывод значений организован через print().)
